                ...
                {booking.booking_items.map((item, index) => (
                  <View key={index} style={{ marginTop: index > 0 ? 16 : 8 }}>
                    ...
                    {item.unit_price ? (
                      ...
                      >
                        {safeString(
                          `Giá: ${(item.unit_price || 0).toLocaleString()} VNĐ`
                        )}
                      </Text>
                    ) : null}
                  </View>
          ...
          >
            <Card.Content style={{ paddingHorizontal: 16, paddingVertical: 8 }}>
              <View style={{ marginTop: 8 }}>
                ...
                <Text style={{ fontSize: 15, fontWeight: "600", marginTop: 4 }}>
                  {safeString(
                    booking.branch_name || booking.branch_code || "N/A"
                  )}
                </Text>
              </View>
              {booking.bay_name ? (
              ...
              {booking.estimated_duration_minutes ? (
                <View style={{ marginTop: 16 }}>
                  ...
                  >
                    {safeString(
                      `${booking.estimated_duration_minutes || 0} phút`
                    )}
                  </Text>
                </View>
              ) : null}
                ...
                >
                  ...
                  {booking.cancelled_at ? (
                    <Text style={{ fontSize: 12, color: "#999", marginTop: 8 }}>
                      {safeString(
                        `Hủy vào: ${formatDate(booking.cancelled_at)}`
                      )}
                    </Text>
                  ) : null}
                </View>
          ...
          >
            ...
            >
              <Card.Content
                style={{ paddingHorizontal: 16, paddingVertical: 8 }}
              >
                <Text style={{ fontSize: 14, lineHeight: 20, marginTop: 8 }}>
                  {safeString(booking.notes)}
                </Text>
              </Card.Content>
            </List.Accordion>
          </Card>
        ...
        <View style={{ flexDirection: "row", gap: 12, marginTop: 8 }}>
          {canUpdate ? (
            <Button
              ...
              onPress={() => {
                router.push(
                  `/history-management/booking-history/update-booking/${booking.booking_id}` as any
                );
              }}
              style={{ flex: 1 }}
